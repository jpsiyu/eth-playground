...
contract Sigma is Base {    
    ...
    {
        _result =  keccak256(abi.encodePacked(this, _borrower, _t1, _t1Amount1, _t1Amount2, _t2, _t2Amount,  _loanMaxTime, _paymentTime, _clientNonce));
    }
   
    function borrow(address _t1, uint _t1Amount1, uint _t1Amount2, address _t2, uint _t2Amount, uint _loanMaxTime, uint _paymentTime, string calldata  _clientNonce) 
        external 
    {
    ...
    function buyClaim1(address _t1, uint _t1Amount1, uint _t1Amount2, address _t2, uint _t2Amount, uint _loanMaxTime, uint _paymentTime, string calldata  _clientNonce, 
    ...
    function testBuyClaim(address _t1, uint _t1Amount1, uint _t1Amount2, address _t2, uint _t2Amount, uint loanMaxTime, uint _paymentTime, string calldata  _clientNonce, 
    ...
    function cancel(address _t1, uint _t1Amount1, uint _t1Amount2, address _t2, uint _t2Amount, uint loanMaxTime, uint _paymentTime, string  calldata  _clientNonce) external 
    {
    ...
    function getPaymentByBuyer(address _t1, uint _t1Amount1, uint _t1Amount2, address _t2, uint _t2Amount, uint _loanMaxTime, uint _paymentTime, string  calldata  _clientNonce,
        address _borrower) external 
    {
      ...
      function getPaymentByBorrower(address _t1, uint _t1Amount1, uint _t1Amount2, address _t2, uint _t2Amount, uint _loanMaxTime, uint _paymentTime, string  calldata  _clientNonce,
        address[] calldata _buyers) external 
    {
    ...
    function getPayment(address _t1, uint _t1Amount1, uint _t1Amount2, address _t2, uint _t2Amount, uint _loanMaxTime, uint _paymentTime, string  calldata  _clientNonce,
        address _borrower, address[] calldata _buyers) external 
    {
        require(_paymentTime <= now);       //只有到期才能还款
